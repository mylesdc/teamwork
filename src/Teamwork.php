...
class Teamwork
{
     ...
     *
     * If no team is given, the current_team_id will be used instead. Optional
     * parameter for inviting a new user with a target role.
     *
     ...
     * @throws \Exception
     */
    public function inviteToTeam( $user, $team = null, $role = null, callable $success = null )
    {
        if ( is_null( $team ) )
        {
